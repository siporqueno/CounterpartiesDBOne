...
public class CounterpartyProductIdOld implements Serializable {
    private String counterpartyShortName;
    private String countryCode;
    private String place;
    private String productShortName;

    public CounterpartyProductIdOld(String counterpartyShortName, String countryCode, String place, String productShortName) {
    ...
    public CounterpartyProductIdOld() {
    }
    ...
    public boolean equals(Object obj) {
        ...
        CounterpartyProductIdOld another = (CounterpartyProductIdOld) obj;
